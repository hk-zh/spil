...
from spil.evaluation.utils import temp_seed
...
sample_initial_state = {'led': 0, 'lightbulb': 0, 'slider': 'right', 'drawer': 'closed', 'red_block': 'slider_left', 'blue_block': 'table', 'pink_block': 'slider_right', 'grasped': 0}
sample_task = ('open_drawer', 'turn_on_lightbulb', 'move_slider_left', 'turn_on_led')
...
def get_sequences_fix(num_sequences=1000, num_workers=None):
    return [(sample_initial_state, sample_task)] * num_sequences
